...
urlpatterns = [
    ...
    path('<int:pk>/update/', views.product_update_view, name='product-edit'), #api/products/id/update
    path('<int:pk>/delete/', views.product_destroy_view, name='product-delete'), #api/products/id/delete
